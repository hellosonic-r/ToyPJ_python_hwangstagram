...
class Main(APIView):
    def get(self, request):
        ...
        feed_object_list = Feed.objects.all().order_by("-id")  # 쿼리셋
        feed_list = []
        ...
        return render(request, "hwangstagram/main.html", context=dict(feed_list=feed_list, user=user))  # render가 넘겨주는 역할
